...
import ATTACK_DAMAGE_IMG from "graphic/assets/img/statIcons/attack_damage.png";
import ATTACK_SPEED_IMG from "graphic/assets/img/statIcons/attack_speed.png";
import ATTACK_RANGE_IMG from "graphic/assets/img/statIcons/attack_range.png";
import MOVE_SPEED_IMG from "graphic/assets/img/statIcons/move_speed.png";
import ARMOR_IMG from "graphic/assets/img/statIcons/armor.png";
import HP_REGEN_IMG from "graphic/assets/img/statIcons/hp_regen.png";
import HP_IMG from "graphic/assets/img/statIcons/hp.png";
import CRITICAL_CHANCE_IMG from "graphic/assets/img/statIcons/critical_chance.png";
import VAMPIRISM_IMG from "graphic/assets/img/statIcons/vampirism.png";
import ARMOR_PENETRATION_IMG from "graphic/assets/img/statIcons/armor_penetration.png";
import FEAR_IMG from "graphic/assets/img/statIcons/fear.png";
import FEAR_RESIST_IMG from "graphic/assets/img/statIcons/fear_resist.png";
...
import Button2D from "graphic/atom/Button2D";
...
const StatDisplayer = (props: StatDisplayerProps) => {
  ...
  const stats = [
    ...
    {
      img: FEAR_RESIST_IMG,
      value: `${playerMe.finalFearResist} (${((0.7 + 0.3 * calcFraction(playerMe.finalFearResist)) * 100).toFixed(
        0
      )}%)`,
      tooltip: "두려움 저항",
    },
